...
export class WalletController {
  ...
  async validateCoupon(
    ...
    return this.walletService.validateCoupon(userId, body.code);
  }
  ...
  async getCouponHistory(
    ...
    return this.walletService.getCouponHistory(userId, pagination);
  }
  ...
  @ApiOperation({ summary: 'إلغاء اشتراك', description: 'إلغاء اشتراك نشط' })
  @ApiParam({ name: 'id', description: 'معرّف الاشتراك' })
  ...
  async cancelSubscription(
    ...
    return this.walletService.cancelSubscription(subscriptionId, userId);
  }
