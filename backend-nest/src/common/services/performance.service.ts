...
export class PerformanceService {
  ...
  constructor(
    @InjectModel('PerformanceMetric') private metricModel: Model<PerformanceMetric>,
    @InjectModel('PerformanceBudget') private budgetModel: Model<PerformanceBudget>,
  ) {}
   ...
   */
  async checkBudgetViolation(metric: PerformanceMetric): Promise<{
    violated: boolean;
    violations: string[];
