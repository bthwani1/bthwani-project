...
import { KenzItem, KenzCategory, CreateKenzPayload, UpdateKenzPayload, KenzCategoryLabels } from '../types';
  ...
  useEffect(() => {
    if (item && mode === 'edit') {
      setFormData({
        ...
        category: item.category || KenzCategory.OTHER,
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                ...
                >
                  {Object.values(KenzCategory).map((category) => (
